<h2><a href="https://www.geeksforgeeks.org/problems/length-of-string/1?page=8&difficulty=Basic&status=unsolved&sortBy=submissions">Length of String</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a string <strong>s</strong>, return the <strong>length</strong> of the string.</span></p>
